...
def selection_lepton_charge(lep_charge_0: np.ndarray, lep_charge_1: np.ndarray, lep_charge_2: np.ndarray, lep_charge_3: np.ndarray) -> np.ndarray:
    """
    Only keep lepton charge combinations resulting from H->ZZ->llll

    Parameters:
        lep_charge_0 (np.ndarray): Charge of lepton 0.
        lep_charge_1 (np.ndarray): Charge of lepton 1.
        lep_charge_2 (np.ndarray): Charge of lepton 2.
        lep_charge_3 (np.ndarray): Charge of lepton 3.

    Returns:
        np.ndarray: Array of booleans indicating whether the event is selected.
    """
...
def selection_lepton_type(lep_type_0: np.ndarray, lep_type_1: np.ndarray, lep_type_2: np.ndarray, lep_type_3: np.ndarray) -> np.ndarray:
    """
    Only keep lepton type combinations resulting from H->ZZ->llll

    Parameters:
        lep_type_0 (np.ndarray): Type of lepton 0.
        lep_type_1 (np.ndarray): Type of lepton 1.
        lep_type_2 (np.ndarray): Type of lepton 2.
        lep_type_3 (np.ndarray): Type of lepton 3.
...
def reweight_weights(weights: np.ndarray, classification: np.ndarray) -> np.ndarray:
    """
    Reweight the weights of the events.
    ...
    Returns:
        np.ndarray: Array of reweighted event weights.
    """
